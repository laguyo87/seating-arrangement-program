 ...
 * 좌석 생성 및 관리 클래스
 */
export declare class SeatModel {
     ...
     * @returns 생성된 Seat 객체
     */
    static create(position: Position, isFixed?: boolean, isActive?: boolean): Seat;
    /**
     * 좌석에 학생을 배정합니다.
     * @param seat 좌석 객체
     ...
     */
    static assignStudent(seat: Seat, studentId: number, studentName: string): void;
    /**
     * 좌석에서 학생을 제거합니다.
     * @param seat 좌석 객체
     */
    static removeStudent(seat: Seat): void;
    /**
     * 좌석이 비어있는지 확인합니다.
     * @param seat 좌석 객체
     * @returns 좌석이 비어있으면 true
     */
    static isEmpty(seat: Seat): boolean;
    /**
     * 좌석이 활성화되어 있고 비어있는지 확인합니다.
     * @param seat 좌석 객체
     * @returns 활성화되어 있고 비어있으면 true
     */
    static isAvailable(seat: Seat): boolean;
    /**
     * 좌석 목록에서 비어있는 좌석만 필터링합니다.
     * @param seats 좌석 배열
     * @returns 비어있는 좌석 배열
     */
    static getEmptySeats(seats: Seat[]): Seat[];
    /**
     * 좌석 목록에서 배정된 좌석만 필터링합니다.
     * @param seats 좌석 배열
     * @returns 배정된 좌석 배열
     */
    static getAssignedSeats(seats: Seat[]): Seat[];
    /**
