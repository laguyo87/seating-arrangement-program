 ...
 * 좌석 배치 알고리즘 서비스
 */
import { Seat, SeatModel, LayoutType, Position } from '../models/Seat.js';
...
export class LayoutService {
     ...
     * @returns 배치된 좌석 배열
     */
    public static createSingleUniformLayout(
        totalSeats: number, 
     ...
     * @returns 배치된 좌석 배열
     */
    public static createPairUniformLayout(
        totalSeats: number,
        canvasWidth: number = 800,
        canvasHeight: number = 600,
        partitionCount: number = 1
     ...
     * @returns 배치된 좌석 배열
     */
    public static createGroupLayout(
        totalSeats: number,
        groupSize: number = 4,
        canvasWidth: number = 800,
        canvasHeight: number = 600
     ...
     * @returns 배치된 좌석 배열
     */
    public static createUShapeLayout(
        totalSeats: number,
        canvasWidth: number = 800
    ): Seat[] {
        const seats: Seat[] = [];
